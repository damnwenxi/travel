    ...
    <el-form ref="form" :model="form" label-width="80px">
      ...
      <el-form-item label="上传商品背景图片">
        ...
        >
          ...
          <div slot="tip" class="el-upload__tip">最多支持上传5张图片</div>
        </el-upload>
      </el-form-item>
...
export default {
  ...
  mounted() {
    ...
    axios({
      url: BASE_URL + "/goods/edit?id=" + this.$route.query.id,
      method: "get",
      headers: {
        Authorization: localStorage.getItem("token")
      }
      ...
      const img = { name: "商品背景图", url: res.data[0].cover };
